import { UserInputInterface, UserLoginInterface, UserUpdateInputInterface } from "@/interfaces/user.interface";
import Joi from "joi";
...
export const loginValidation = (payload: UserLoginInterface) => {
    const schema = Joi.object({
